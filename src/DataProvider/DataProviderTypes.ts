...
export type IDataProvider<ResourceType extends string = string> = {
    ...
    subscribe: (topic: string, subscriptionCallback: any) => Promise<any>
  
    unsubscribe: (topic: string, subscriptionCallback: any) => Promise<any>
  
    publish: (topic: string, event: any) => Promise<any>

    lock: (resource: string, { id, identity, meta }: any) => Promise<any>

    unlock: (resource: string, { id, identity, meta }: any) => Promise<any>

    getLock: (resource: string, { id, meta }: any) => Promise<any>

    getLocks: (resource: string, { meta }: any) => Promise<any>
